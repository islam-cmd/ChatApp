    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc_btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(DocRegActivity.this, RegisterActivity.class);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(text_username) || TextUtils.isEmpty(text_email) || TextUtils.isEmpty(text_password)) {
                    Toast.makeText(DocRegActivity.this, "All fields are Required", Toast.LENGTH_SHORT).show();
                } else if (text_password.length() < 6) {
                    Toast.makeText(DocRegActivity.this, "password must be at least 6 characters", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            refrence.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Intent intent = new Intent(DocRegActivity.this, DocMainActivity.class);
                            ...
                            Toast.makeText(DocRegActivity.this, "You Can't Register with this email or Password.", Toast.LENGTH_SHORT).show();
                        }
